...
# Unescape HTML entities first so our string replacements actually work!
html = html_lib.unescape(html)

# Now, we do the EXACT replacements from Lovable's text to our t.* bindings
...
html = html.replace('Prezzo di mercato', '{{ t.pricingHeaderMarket }}')
...
html = html.replace("Dal primo messaggio alla tua chiesa, in quattro passi.", '{{ t.howTitle }}')
...
html = html.replace("Risposte per pastori, amministratori e responsabili ministeriali.", '{{ t.faqTitle }}')
